...
export async function POST(req) {
    try {
        ...
        const { name, id, profileStatus, contactNo, country, roleId, roleName } = body;
        ...
        const fields = { name, profileStatus, contactNo, roleName, country };
        ...
        const updatedProfile = await prisma.user.update({ where: { id: id }, data: { name, profileStatus, contactNo, country, roleId, roleName } });
